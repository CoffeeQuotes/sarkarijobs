...
@section('content')
<div class="pt-5">
    <h3><strong class="text-white rounded bg-primary p-1">{{ $article->type}}</strong> / <span><strong class="text-white rounded bg-primary p-1">{{ $article->category->name}}</strong></span></h3>
</div>
<div class="pt-5">
