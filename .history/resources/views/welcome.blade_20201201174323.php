...
<div class="container pt-5">
    ...
    <div class="row py-5">
      <div class="col-sm">
          <h3 class=" p-1 text-center rounded text-dark">Latest Jobs</h3>
        @foreach($jobs as $key => $job)
            ...
            @endif
            {{$job->updated_at->diffForHumans()}}</a>
        @endforeach
        <br/><br/><br/>
      ...
      <div class="col-sm">
          <h3 class="  p-1 text-center rounded text-dark">Results</h3>
        @foreach($results as $key => $result)
            ...
            <img src="https://img.icons8.com/doodle/48/000000/new--v1.png" width="24" height="auto" />
            @endif
                {{$result->updated_at->diffForHumans()}}</a>
            </a>
        @endforeach
        <br/><br/><br/>
      ...
      <div class="col-sm">
        <h3 class="  p-1 text-center rounded text-dark">Admissions</h3>
        @foreach($admissions as $key => $admission)
            ...
            <img src="https://img.icons8.com/doodle/48/000000/new--v1.png" width="24" height="auto" />
            @endif
                {{$admission->updated_at->diffForHumans()}}</a>
            </a>
        @endforeach
        <br/><br/><br/>
        <a class="btn btn-sm btn-primary" href="{{route('article','Results')}}">View All</a>
    ...
    <div class="row mt-5">
        <div class="col-sm">
            <h3 class="  p-1 text-center rounded text-dark">Syllabus</h3>
          @foreach($syllabus as $key => $syllabi)
            ...
            <img src="https://img.icons8.com/doodle/48/000000/new--v1.png" width="24" height="auto" />
            @endif
                {{$syllabi->updated_at->diffForHumans()}}</a>
            </a>
          @endforeach
          <br/><br/><br/>
          <a class="btn btn-sm btn-primary" href="{{route('article','Results')}}">View All</a>
        ...
        <div class="col-sm">
            <h3 class="  p-1 text-center rounded text-dark">Answer Keys</h3>
          @foreach($answerKeys as $key => $answers)
            ...
            <img src="https://img.icons8.com/doodle/48/000000/new--v1.png" width="24" height="auto" />
            @endif
                {{$answers->updated_at->diffForHumans()}}</a>
            </a>
          @endforeach
          <br/><br/><br/>
          <a class="btn btn-sm btn-primary" href="{{route('article','Results')}}">View All</a>
        ...
        <div class="col-sm">
            <h3 class="  p-1 text-center rounded text-dark">Admit Card</h3>
          @foreach($admitCards as $key => $admit)
            ...
            <img src="https://img.icons8.com/doodle/48/000000/new--v1.png" width="24" height="auto" />
            @endif
                {{$admit->updated_at->diffForHumans()}}</a>
            </a>
          @endforeach
          <br/><br/><br/>
          <a class="btn btn-sm btn-primary" href="{{route('article','Results')}}">View All</a>
      ...
      <div class="row mt-5">
          <div class="col-sm">
            <h3 class="  p-1 text-center rounded text-dark">Certificates</h3>
            ...
            <img src="https://img.icons8.com/doodle/48/000000/new--v1.png" width="24" height="auto" />
            @endif
                {{$certificate->updated_at->diffForHumans()}}</a>
              </a>
            @endforeach
            <br/><br/><br/>
          ...
          <div class="col-sm">
            <h3 class="  p-1 text-center rounded text-dark">Importants</h3>
