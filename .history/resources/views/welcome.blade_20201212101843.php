...
<div class="container pt-5">
    ...
    <div class="row py-5">
            {{-- Latest Job --}}
                <div class="col-sm py-4 neumorph">
    ...
    <div class="row mt-5">
          ...
          <a class="btn btn-sm btn-primary" href="{{route('article','Admit Card')}}">View All</a>
          @endif
        </div>
            {{--Syllabus--}}
                <div class="col-sm py-4 neumorph">
          ...
          <a class="btn btn-sm btn-primary" href="{{route('article','Syllabus')}}">View All</a>
          @endif
        </div>
            {{--Certificates --}}
                <div class="col-sm py-4 neumorph">
    ...
    {{--Third Row --}}
      <div class="row mt-5">
        ...
        <a class="btn btn-sm btn-primary" href="{{route('article','Admissions')}}">View All</a>
        @endif
      </div>
          {{--Impotants --}}
            <div class="col-sm py-4 neumorph">
          ...
          <a class="btn btn-sm btn-primary" href="{{route('article','Answer keys')}}">View All</a>
          @endif
        </div>
      </div>
  </div>
